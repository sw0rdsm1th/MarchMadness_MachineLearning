...
def build_team_dict():
    team_ids = pd.read_csv('/Users/agordon/Desktop/MM1/data-v3/Teams.csv')
    team_id_map = {}
...
if __name__ == "__main__":
    ...
    initialize_data()
    season_data = pd.read_csv('/Users/agordon/Desktop/MM1/data-v3/RegularSeasonDetailedResults.csv')
    tourney_data = pd.read_csv('/Users/agordon/Desktop/MM1/data-v2/TourneyDetailedResults.csv')
    ...
    print("Getting teams.")
    seeds = pd.read_csv('/Users/agordon/Desktop/MM1/data-v3/TourneySeeds.csv')
    ...
    with open('/Users/agordon/Desktop/MM1/data-v2/submission.csv', 'w') as f:
        writer = csv.writer(f)
    ...
    with open('/Users/agordon/Desktop/MM1/data-v2/readable-predictions.csv', 'w') as f:
        writer = csv.writer(f)
        writer.writerows(readable)
    with open('/Users/agordon/Desktop/MM1/data-v2/less-readable-predictions.csv', 'w') as f:
        writer = csv.writer(f)
